...
<style>
    ...
    /* Gleiche Spaltenzahl und gleiche Breite wie das Inhaltsraster
       darueber, damit die Seite eine einzige rechte Kante hat. */
    .link-list {
        list-style: none;
        margin: 0;
        padding: 0;
    ...
    @media (min-width: 1280px) {
        .link-list { grid-template-columns: repeat(3, minmax(0, 1fr)); column-gap: 64px; }
    }
