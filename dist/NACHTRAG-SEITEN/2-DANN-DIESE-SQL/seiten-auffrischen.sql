-- ============================================================
-- SUI Innova GmbH — Seiten auffrischen
--
-- ERZEUGT VON dist/scripts/build_keyword_pages.php refresh
--
-- Baut die Sektionen der sechs Keyword-Seiten neu auf, in der
-- aktuellen Fassung mit zweispaltigem Raster statt Textwand.
--
-- WANN BRAUCHT MAN DAS:
--   Wenn eine aeltere Fassung der Seiten schon eingespielt wurde.
--   Die normale Datei legt bestehende Seiten nicht noch einmal an
--   und wuerde die alte Struktur stehen lassen.
--
-- WAS PASSIERT:
--   Ein gewaehltes Kopfbild bleibt erhalten. Alles andere an
--   diesen sechs Seiten wird ersetzt. Titel, Beschreibung und
--   der Online-Status der Seiten bleiben unangetastet.
--
